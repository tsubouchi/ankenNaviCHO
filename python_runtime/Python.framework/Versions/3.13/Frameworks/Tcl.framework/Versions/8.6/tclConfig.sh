...
TCL_EXTRA_CFLAGS='-arch arm64 -arch x86_64 -pipe   -mmacosx-version-min=10.13 '
...
# build directory.
TCL_BUILD_LIB_SPEC='-F/Users/nad/build_macos_installer/installer/variant/binaries/build/libraries/build/tcl/Deployment -framework Tcl'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-F/Frameworks -framework Tcl'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Frameworks/Tcl.framework/Versions/8.6/Headers'
...
# compiled.
TCL_SRC_DIR='/Users/nad/build_macos_installer/installer/variant/binaries/build/_bld/tcl8.6.16'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='~/Library/Tcl:/Library/Tcl:~/Library/Frameworks:/Library/Frameworks:/Library/Frameworks/Tk.framework/Versions'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/nad/build_macos_installer/installer/variant/binaries/build/libraries/build/tcl/Deployment -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Frameworks/Tcl.framework/Versions/8.6 -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/nad/build_macos_installer/installer/variant/binaries/build/libraries/build/tcl/Deployment/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Frameworks/Tcl.framework/Versions/8.6/libtclstub8.6.a'
