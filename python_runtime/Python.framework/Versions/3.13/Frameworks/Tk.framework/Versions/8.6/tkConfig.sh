...
# build directory.
TK_BUILD_LIB_SPEC='-F/Users/nad/build_macos_installer/installer/variant/binaries/build/libraries/build/tk/Deployment -framework Tk'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-F/Frameworks -framework Tk'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Frameworks/Tk.framework/Versions/8.6/Headers'
...
# compiled.
TK_SRC_DIR='/Users/nad/build_macos_installer/installer/variant/binaries/build/_bld/tk8.6.16'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Users/nad/build_macos_installer/installer/variant/binaries/build/libraries/build/tk/Deployment -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Frameworks/Tk.framework/Versions/8.6 -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/nad/build_macos_installer/installer/variant/binaries/build/libraries/build/tk/Deployment/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Frameworks/Tk.framework/Versions/8.6/libtkstub8.6.a'
