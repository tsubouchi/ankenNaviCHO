...
def setup_chromedriver():
    ...
    os.makedirs(data_dir / 'drivers', exist_ok=True)
    
    # ChromeDriverのキャッシュ情報を確認
    cache_info_path = data_dir / ".chromedriver_cache_info"
    driver_path = None
    ...
    if os.path.exists(cache_info_path):
        try:
            ...
            if "PATH" in cache_info and Path(cache_info["PATH"]).exists():
                driver_path = cache_info["PATH"]
